            ...
            <form>
                ...
                <div class="grid sm:grid-cols-12 gap-2 sm:gap-6">
                    ...
                    <div class="sm:col-span-9">
                        ...
                        <p class="mt-3">
                            <a class="inline-flex items-center gap-x-1 text-sm text-amber-600 decoration-2 hover:underline font-medium dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
